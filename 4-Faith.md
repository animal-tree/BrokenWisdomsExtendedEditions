...
CMT deleted their record of my MHDPA innovation paper, the one that foretold ChatGPT to my university, the same month when I was terminated (Microsoft’s deleting of that record at around that time can be verified, since they sent out a notification email on 10/20/23 to everybody that they were updating their data retention policy). But in 2018, the paper was sent out to Henry Kautz and Daniel Gildea by email, and submitted to the class as that class’s end of semester project via email. So the bare minimum digital record does remain to verify the paper and its being written in 2018 with the first initial successful experiments, and email record of Henry and Dan's respective advice on how to mathematically or linguistically describe MHDPA, claiming more math was needed and that “relational reasoning” is the wrong term (though what I had and stuck with is now the convention, and already had some precedent then). That’s not to insult Henry or Dan. There’s also clear record that, no, most deep learning and even natural language processing researchers hadn’t heard of MHDPA at the time of my paper, with a few DeepMind papers at the time and not much other interest. [Only 5 papers that mention MHDPA on Google Scholar from that date range](https://scholar.google.com/scholar?q=mhdpa&hl=en&as_sdt=0%2C33&as_ylo=2017&as_yhi=2018), and only [one of them](https://proceedings.neurips.cc/paper/2018/hash/e2eabaf96372e20a9e3d4b5f83723a61-Abstract.html) innovates on MHDPA. In fact, while I was finishing up the code for my paper in Montreal during NeurIPS (called "NIPS" at the time) 2018, I met one of the authors of that paper, Ryan Faulkner, and we got lunch and he even said he'd recommend me to a position at DeepMind since he was so impressed with me —  yes really. There were papers at the time that referenced Attention Is All You Need, but MHDPA was esoteric in 2018, despite some people believing it blew up immediately in 2017 — but no, it was esoteric. Probably everywhere, definitely at my university. So yes, I “foretold” a major advancement to my university and was received with mostly criticism and doubt from my superiors, a pattern that repeated again and again many times. And not only foretold, but innovated on and executed successful experiments verifying the early innovation — and later formal paper submission that got derailed by a sudden, unprecedented psychosis. 

### "Sam Altman" same-time termination, OpenAI's Q* project

Description [Namely, the head of OpenAI, the company that invented ChatGPT (that used the same method I was still uncredited for by my university for foretelling to them), whose name is "Sam Altman" (mine is Sam Lerman), and "Altman" does not mean "teacher," was terminated as the head of OpenAI in an unusually sensationalized situation exactly 17 days after my termination]
