...
> - (c) decomposing those representations into representations of parts and relations (such as with image segmentation, word vectors, parameter re-use inductive biases in neural networks like convolution, recurrence, attention, vector-quantization; or, more elementarily, weighted sums with non-linearities; or frozen parameters of trained or symbolic encoders),
