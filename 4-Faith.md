...
>       - "Attention is all you need" is the paper that proposed MHDPA, the method underlying most newer neural networks, including ChatGPT. The fundamental method for relational reasoning in big AI systems shouldn't be referencing a gaslighting association like "You just want attention." when a much better analogy exists.
>
