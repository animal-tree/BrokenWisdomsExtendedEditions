...
>    - (relevant method examples: such as via K-nearest neighbors; neural episodic control; parametrically rather than symbolically via RNNs or Decision Transformers),
