...
> - (e) [attention as convolution](https://github.com/slerman12/BrokenWisdoms/blob/Ancillary/Conv-is-all-you-need.md).
>   - Second note: "Attention is all you need” sounds like a reply to "You just want attention.” It’s in bad taste. That’s the name of the paper from DeepMind that most revolutionized deep learning after 2017. My later paper under Chenliang was going to be called, "Relation is all you need,” which brings the idea slightly closer to "Relationships are all you need” or John Lennon’s phrasing, "Love is all you need.”
