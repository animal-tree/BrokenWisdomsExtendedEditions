...
My family besides me had also earned higher-level degrees. My mom, a master's degree in music theory. My uncles Slava and Sasha, PhDs, in physics and mathematics, respectively. My cousins, PhDs in medical fields. My sister, working to become a nurse practitioner (master's degree) [to do: fact check: she might've already gotten it at that point]. And my best friend, also in a PhD program but in another city. All were proud of me. None knew the details of the psychosis that led to the RGH hospitalization. Henry didn't know about all of that either. This book is the witnessing in real-time as I processed all that memory into writing.
