...
- However, Daniel Gildea, who hadn’t previously heard of MHDPA, gave me an A for my 2018 ChatGPT paper that I did for his grad-level Semantic Parsing class as a class project. My head, eyebrows, and eyelashes were already bald at that point. I remember prior to the semester project, at one point he said “it’s amazing he even got this far” about the author of some semantic parsing paper using AMRs (a symbolic method that wasn't at the time in the entire field of semantic parsing, at least of the papers we read, used with MHDPA — notably, of those papers the Attention Is All You Need paper was not one of them) — for how far the paper’s model got — and for some reason I heard it in my head like a cryptic expression about me, but was aware by any conscious interpretation of reality, it wasn’t. Though over the next 4 years, I got much further in my research predictions than those methods that underlie ChatGPT. 
