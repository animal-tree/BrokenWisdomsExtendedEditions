...
But I bring him up now because the rest of this book is going to point to some serious problems more specifically, and address the specific reforms I've been referencing, specifically. These are reforms that aren't redundant to the ones Bernie Sanders has already pointed out, and unlike many bleeding-hearts who’ve copied him since, I’m sincere, and mine is gushing to the floor, with a main artery that can take it. How to transition into this? Well...
